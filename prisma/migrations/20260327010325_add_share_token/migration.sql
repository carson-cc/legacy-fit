/*
  ...
  - The required column `shareToken` was added to the `AssessmentResult` table with a prisma-level default value. This is not possible if the table is not empty. Please add this column as optional, then populate it before making it required.
...
INSERT INTO "new_AssessmentResult" ("adaptationStress", "createdAt", "domPercentile", "dominance", "extPercentile", "extraversion", "fitPct", "forPercentile", "formality", "id", "inviteId", "list1Count", "list1Order", "list1Responses", "list2Count", "list2Order", "list2Responses", "patPercentile", "patience", "profileGroup", "profileName", "recruiterNotes", "rushed", "scoringVersion", "secondaryProfile", "timeOnPage1Ms", "timeOnPage2Ms") SELECT "adaptationStress", "createdAt", "domPercentile", "dominance", "extPercentile", "extraversion", "fitPct", "forPercentile", "formality", "id", "inviteId", "list1Count", "list1Order", "list1Responses", "list2Count", "list2Order", "list2Responses", "patPercentile", "patience", "profileGroup", "profileName", "recruiterNotes", "rushed", "scoringVersion", "secondaryProfile", "timeOnPage1Ms", "timeOnPage2Ms" FROM "AssessmentResult";
