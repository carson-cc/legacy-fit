  ...
  try {
    ...
    return NextResponse.json({
      data: {
        ...
        composite: computeCompositeDimensions({
          dominance:   result.dominance,
          extraversion: result.extraversion,
          patience:    result.patience,
          formality:   result.formality,
        }),
        compositeBenchmark: invite.job.target ? computeCompositeDimensions({
          dominance:   invite.job.target.dominance,
          extraversion: invite.job.target.extraversion,
          patience:    invite.job.target.patience,
          formality:   invite.job.target.formality,
        }) : null,
        percentiles: {
