...
const VALUE_PROPS = [
  {
    title: 'A behavioral profile on every candidate',
    body: 'Before you present them. Before the interview. Before the offer.',
  },
  {
    title: 'A client deliverable that looks premium',
    body: 'Share a report link with any hiring manager. No login required.',
  },
  {
    title: 'The differentiator',
    body: 'Mode B: your client\u2019s hiring manager takes the same assessment. Every report shows candidate\u2013manager fit.',
  },
]

export default function ForStaffingFirmsPage() {
  return (
    <div style={{ background: 'var(--p-bg)', minHeight: '100vh', color: 'var(--p-t0)' }}>
      ...
      {/* Social Proof */}
      <section style={{ borderTop: '1px solid var(--p-b0)', padding: '48px var(--p-sp) 48px' }}>
        <p style={{ fontSize: 14, color: 'var(--p-t2)', lineHeight: 1.6 }}>
          Used by {PRODUCT_NAME} clients including Ford Motor Company and Gilbane Construction.
        </p>
      </section>
